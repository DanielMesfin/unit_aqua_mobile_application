...
class ReportContainer extends StatelessWidget {
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 8.0),
          planktonController.responseModel.value != null
              ? Text("Plankton Result",
                  style: ThemeText.bodyBoldOne.copyWith(color: Colors.black),
          ...
          planktonController.responseModel.value != null
              ? PlanktonExists(
                  planktonController.responseModel.value,
                )
              : SizedBox(),
          resultdata['remarkText'] != null
              ? Text("Remarks: ${resultdata['remarkText']}")
              : SizedBox(),
          Container(
            width: double.infinity,
  ...
  PlanktonExists(ResponseModel? dataResponse) {
    ...
    final data = List<List<dynamic>>.generate(
      // usefulAndHarmfulFields.length,
      15,
      (index) => <dynamic>[
        usefulAndHarmfulFields[index][0],
        result[index][1],
      ],
    );
    final harmFullFarmdata = List<List<dynamic>>.generate(
    ...
    final useFullFarm = ['UseFul Plankton', 'Units'];
    final harmFullFarm = ['HarmFul Plankton', 'Units'];
    ...
    return Table(
      ...
      children: [
        ...
        //           // No vertical borders for this row
        //         ),
        //       ),
        //     ) // Empty cell to span across columns
        //         ),
        //   ],
        // ),
        ...
        TableRow(
          ...
          children: useFullFarm.map((header) {
            return TableCell(
              child: Padding(
        ...
        TableRow(
          ...
          children: harmFullFarm.map((header) {
            return TableCell(
              child: Padding(
                padding: const EdgeInsets.all(6.0),
                child: Text(
                ...
                return TableCell(
                  child: Padding(
                      ...
                      child: Text(
                        cellData.toString(),
                        style:
                            ThemeText.bodyOne_50.copyWith(color: Colors.black),
                      )),
                );
              }).toList(),
            );

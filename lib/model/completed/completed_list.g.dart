...
CompletedList _$CompletedListFromJson(Map<String, dynamic> json) =>
    CompletedList(
...
Map<String, dynamic> _$CompletedListToJson(CompletedList instance) =>
    <String, dynamic>{
...
Result _$ResultFromJson(Map<String, dynamic> json) => Result(
      ...
      pcr: (json['pcr'] as List<dynamic>?)
          ?.map((e) => Pcr.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Pcr _$PcrFromJson(Map<String, dynamic> json) => Pcr(
      id: (json['id'] as num?)?.toInt(),
...
Map<String, dynamic> _$PcrToJson(Pcr instance) => <String, dynamic>{
      'id': instance.id,
      // 'pcr': instance.pcr,
      'testId': instance.testId,
      'suggestion': instance.suggestion,
...
Water _$WaterFromJson(Map<String, dynamic> json) => Water(
      ...
      co3: (json['co3'] as num?)?.toDouble(),
      hco3: (json['hco3'] as num?)?.toDouble(),
      ...
      totalDissolvedSolids: (json['totalDissolvedSolids'] as num?)?.toDouble(),
      suggestion: json['suggestion'] as String?,
      testId: (json['testId'] as num?)?.toInt(),
      status: json['status'] as String?,
      createdAt: json['createdAt'] as String?,

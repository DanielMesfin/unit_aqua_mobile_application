...
class MyCompletedReportView extends GetView<MyCompletedReportViewController> {
  const MyCompletedReportView({super.key});
              ...
              child: SingleChildScrollView(
                child: Obx(
                  () => controller.isLoading.isTrue
                      ...
                      : GetBuilder<MyCompletedReportViewController>(
                          builder: (controller) {

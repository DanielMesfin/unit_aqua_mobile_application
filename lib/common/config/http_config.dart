class HttpConfig {
  ...
  static const String baseUrl = "https://kbackend-yihi.onrender.com/";
  ...
  static const int defaultConnectionTimeOut = 10 * 1000; 
  static const int longConnectionTimeOut = 60 * 1000; 
  static const int defaultReceiveTimeOut = 10 * 1000; 
  static const int longReceiveTimeOut = 60 * 1000; 
}
